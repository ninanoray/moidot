...
export const META = {
  title: "모이닷 | Moidot",
  siteName: "모이닷",
  description: "잇고 모여서, 계속 이어지는 모임 - 모이닷",
  keywords: ["모이닷", "moidot"],
  base: BASE_URL,
  url: BASE_URL,
...
export const STARTUP_IMAGES = [
  {
    url:
      META.base + "/assets/ios/splash-screens/iPhone_16_Pro_Max_portrait.png",
    media:
  ...
  },
  {
    url:
      META.base +
      "/assets/ios/splash-screens/iPhone_11__iPhone_XR_portrait.png",
    media:
